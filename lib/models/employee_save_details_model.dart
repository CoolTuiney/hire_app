...
//
//     final employeeSaveDetailsModel = employeeSaveDetailsModelFromJson(jsonString);

import 'dart:convert';

EmployeeSaveDetailsModel employeeSaveDetailsModelFromJson(String str) => EmployeeSaveDetailsModel.fromJson(json.decode(str));

String employeeSaveDetailsModelToJson(EmployeeSaveDetailsModel data) => json.encode(data.toJson());

class EmployeeSaveDetailsModel {
    int? umdId;
    int? umId;
    ...
    factory EmployeeSaveDetailsModel.fromJson(Map<String, dynamic> json) => EmployeeSaveDetailsModel(
        umdId: json["umdId"],
        umId: json["umId"],
